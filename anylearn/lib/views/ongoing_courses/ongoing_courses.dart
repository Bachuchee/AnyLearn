...
class OngoingCourses extends ConsumerStatefulWidget {
  const OngoingCourses({Key? key}) : super(key: key);

  @override
  ConsumerState<OngoingCourses> createState() => _OngoingCoursesState();
}

class _OngoingCoursesState extends ConsumerState<OngoingCourses> {
  ...
  Widget build(BuildContext context) {
    ...
    PocketClient.getOngoingCourses(topicFilter).then(
